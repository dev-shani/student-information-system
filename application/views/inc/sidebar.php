    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('admin/approval_requests') ?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Approval requests</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('admin/timetable_requests') ?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>TimeTable requests</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="subjects" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('admin/add_subject') ?>">Add Subject</a>
                        <a class="collapse-item" href="<?= base_url('admin/subjects') ?>">Subjects</a>
                        <a class="collapse-item" href="<?= base_url('admin/allocate_subject') ?>">Allocate subject</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="Classes" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('admin/add_class') ?>">Add Class</a>
                        <a class="collapse-item" href="<?= base_url('admin/classes') ?>">Classes</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="Teachers" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('admin/add_teacher') ?>">Add Teacher</a>
            ...
            <?php if($user->role == TEACHER): ?>
                <li class="nav-item">
                    ...
                    <div id="Subjects" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="<?= base_url('teacher/allocated_subjects') ?>">Allocated Subjects</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $user ? $user->first_name : '' ?> <?= $user ? $user->last_name : '' ?></span>
